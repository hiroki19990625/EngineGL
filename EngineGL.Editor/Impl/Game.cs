...
namespace EngineGL.Editor.Impl
{
    public class Game : IGame
    {
        ...
        public virtual void LoadDefaultFunc(IntPtr imePtr)
        {
        ...
        public virtual void DrawDefaultFunc(FrameEventArgs ev, Size clientSize)
        {
            GL.Clear(ClearBufferMask.ColorBufferBit | ClearBufferMask.DepthBufferBit);

            ImGui_Render(ev, clientSize);
        }

        public virtual void AdjustResize(Rectangle clientRectangle)
        {
        ...
        protected unsafe void ImGui_Init(IntPtr imePtr)
        {
            ImGuiIOPtr io = ImGui.GetIO();

            ImGui_Input_Init(io);

            io.ImeWindowHandle = imePtr;
        ...
        protected unsafe void ImGui_Input_Update(bool focused, Point windowPoint)
        {
            ImGuiIOPtr io = ImGui.GetIO();
        ...
        protected unsafe void ImGui_Render(FrameEventArgs ev, Size clientSize)
        {
            ImGuiIOPtr io = ImGui.GetIO();
        ...
        internal void OnUpdateFrame(FrameEventArgs e, bool focused, Point clientPoint)
        {
            try
            {
                ImGui_Input_Update(focused, clientPoint);
                foreach (IScene scene in _loadedScenes.Values)
                {
