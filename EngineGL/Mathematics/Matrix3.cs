...
namespace EngineGL.Mathematics
{
    ...
    class Matrix3 : IEquatable<Matrix3>
    {
        ...
        public Matrix3(params Vector3[] vec3s)
        {
        ...
        public Matrix3(IEnumerable<Vector3> vec3s)
        {
            Vector3[] vec3Array = vec3s.ToArray();
        ...
        public static Vector3 operator *(Matrix3 matrix3, Vector3 b)
        {
